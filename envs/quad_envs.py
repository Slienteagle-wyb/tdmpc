...
def make_quadrotor_env_multi(cfgs):
    ...
    extended_obs = cfg.env.neighbor_obs_type
    env = QuadrotorEnvMulti(
        ...
        sense_noise=cfg.sense_noise, init_random_state=True, ep_time=cfg.episode_duration, room_length=cfg.room_dims[0],
        ...
        use_replay_buffer=cfg.use_replay_buffer, obstacle_obs_mode=cfg.quads_obstacle_obs_mode,
